...
from courses.views import HomeView,AboutView,ContactView,CourseListView, CourseDetailView,LessonDetailView, RequestView, CourseSearchView
...
urlpatterns = [
    ...
    path('request/', RequestView.as_view(), name='request_teacher'),
